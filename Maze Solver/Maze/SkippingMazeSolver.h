...
public:
	...
	std::list<Direction> *pathToFullPath( std::list<Direction> *path ) 
	{
		std::list<Direction>::iterator pathIter = path->begin();
		std::list<Direction> *pFullPath = new std::list<Direction>();
